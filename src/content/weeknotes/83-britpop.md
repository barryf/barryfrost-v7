...
- I've been enjoying Channel 5's [Britpop series](https://www.channel5.com/show/britpop-the-music-that-changed-britain/season-1/the-story-of-britpop). Blur, Oasis and Pulp were all there of course, but of more interest was the time spent diving into Suede, Elastica and even Menswear. I've got a couple more episodes to catch up on.
...
- I finally spent some time updating dependencies and the version of Node used for my website's [software](https://github.com/barryf/vibrancy). As is the way, I ended up [yak-shaving](https://en.wiktionary.org/wiki/yak_shaving). I fixed the broken tests, but they then failed when running in GitHub Actions. I then got them running on Actions but not locally. I cracked it eventually, but I think it's best to leave programming to AI in future.
