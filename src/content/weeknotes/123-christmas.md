...
- I used my well-honed [cooking schedule](https://barryfrost.com/2022/12/week-70-christmas) from previous years, and aside from unexpectedly crumbly potatoes, the main event went smoothly. Next time I need to downsize the turkey: the quantity of leftovers was obscene.
...
- We also went all-in with the Premier [Apple One](https://www.apple.com/uk/apple-one/) bundle. The boys wanted their own Music accounts and because we already subscribed to iCloud storage, Arcade and TV+ the pricing made sense. I really should have Apple stock by now.
- The new bundle meant I needed to switch from my personal Spotify membership. I used the Pro version of [Songshift](https://songshift.com) to successfully transfer the playlists and 500-odd albums in my library. I expected a few albums not to be matched, but Apple Music's catalogue is so large that it all worked seamlessly. I'm not missing Spotify. The UI had become so cluttered with podcasts and audiobooks. Music is just music.
- The boys, and especially C, are obsessed with the Super Mario Bros film. And the [Peaches](https://en.wikipedia.org/wiki/Peaches_(Jack_Black_song)) song, which is now my ear-worm.
