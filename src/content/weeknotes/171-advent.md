...
- I've been enjoying [The Rest Is History](https://www.goalhangerpodcasts.com/the-rest-is-history) podcasts on my commute to work and walks around the village, in particular the Nelson, French Revolution and Roman Conquest episodes. Tom and Dominic are so engaging. It feels like you're part of their conversation.
- I've continued experimenting with Generative AI coding tools. I walked through the [GitHub Copilot](https://github.com/features/copilot) tutorials and then kept tinkering. It's no substitute for knowing the fundamentals: I had to point out a couple of mistakes it had made which it then cheerfully corrected. I guess I also need more practice. I'm going to give new entrant [Windsurf](https://codeium.com/windsurf) a try.
