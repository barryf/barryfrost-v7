...
date: 2011-05-11
featured: true
standardRkey: 374yn2jis2222
---
import { Image } from 'astro:assets';
import fml from '../../assets/fml.jpg';
...
<Image src={fml} alt="Fuck My Life - box containing bottle of eye drops" class="float-left mt-1 mr-8 rounded" />In fact, my surgery was rescheduled three times. My eyes were just too dry to proceed and so I was given a series of new drops to try, including the fabulously-named FML (see photo, right).
...
If you're considering it, speak to a professional and if it's right for you, go for it. Really. Don't put it off. I'd be happy to answer any questions you might have: [contact me](/contact).
