...
import jetBoat from '@/assets/travelblog/jet-boat.jpg';
import meArsenal from '@/assets/travelblog/me-arsenal.jpg';
...
<div class="float-left -mt-8 mr-8 -mb-4 max-w-50">
  <Image src={meBeach} alt="Man paddling on a beach holding his shoes with rocks close by." class="rounded" />
  <Caption>We went to Waiheke Island and paddled on the beach.</Caption>
</div>
...
<Image src={jetBoat} alt="Yellow speedboat mid-air through white rapids." class="rounded" />
<Caption>We had a ride on a jet boat up and down some rapids just outside Taupo.</Caption>
...
<div class="float-left -mt-8 mr-8 max-w-60">
  <Image src={meArsenal} alt="Man paddling on a beach wearing a red Arsenal shirt." class="rounded" />
  <Caption>Being a big Arsenal fan, here's a photo of me showing off my team colours on Cheltenham Beach in Devenport. Note how I'm miles from the beach and yet still paddling: bonkers!</Caption>
</div>
...
<div class="clear-left">Back to work...</div>
