...
import sandSurf from '@/assets/travelblog/sand-surf.jpg';
...
<div class="flex gap-2 overflow-x-auto -my-4">
  <Image src={sandSurf} alt="Man on his stomach riding a boogie board down a sand dune." class="shrink-0 rounded-l-xl object-cover object-center w-72 h-50" />
  <Image src={capeReinga} alt="Lighthouse on a hill overlooking the ocean and sea." class="shrink-0 object-cover object-center w-72 h-50" />
  <Image src={beachBus} alt="Man standing next to a yellow bus stopped on a beach." class="shrink-0 rounded-r-xl object-cover object-center w-72 h-50" />
</div>
