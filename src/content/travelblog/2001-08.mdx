...
import pooPub from '@/assets/travelblog/poo-pub.jpg';
...
<Image src={skyDive} alt="Two people jumping from a plane flying high above the ground." class="rounded" />
...
<Image src={glacier} alt="Man in warm clothes walking inside a glacier." class="rounded float-left mr-8 mt-0" />
