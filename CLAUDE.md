...
Personal website for Barry Frost. Astro 7 + Tailwind CSS, deployed to Cloudflare Workers.
See `PLAN.md` for full architecture, URL structure, and content type details.

Live at `https://barryfrost.com`. Point XRay, feed readers, and other external checks at the live URL.
